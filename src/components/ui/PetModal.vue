<template>
    <div class="fixed bg-[rgba(41,41,41,0.6)] h-screen w-screen top-0 left-0 z-40 flex justify-center items-center" @click="close">
        <div class="w-[240px] sm:w-[630px] md:w-[900px] relative" @click.stop>
